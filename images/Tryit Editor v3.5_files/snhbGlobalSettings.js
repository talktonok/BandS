...
snhb.globalSettings = {  
    currencyConversionEURTo: {
        ...
        USD: { year: 2018, month: 6, rate: 1.1678 },
        AUD: { year: 2018, month: 6, rate: 1.5579 },
        NZD: { year: 2018, month: 6, rate: 1.6822 }
    },    
    bidderAdjustments: {
    ...
    gdpr: {
		...
		banner: {
			...
			links: {
				data: {
					...
					description: "Données pouvant être utilisées:<ul><li>Données sur le navigateur utilisé</li><li>Données sur le systeme d'exploitation utilisé</li><li>Données des cookies</li><li>Données spécifiques au terminal (ordinateur de bureau, mobile...)</li><li>Adresse IP</li><li>Données de navigation (pages visitées)</li><li>Données de géolocalisation</li></ul>"
				},
				purposes: {
					title: 'Utilisation des données',
					description: "A quoi servent ces données:<ul><li>Stockage et accès à ces données</li><li>Publicités personnalisées</li><li>Contenus personnalisés</li><li>Mesure d'audience</li></ul>"
				},
				manage: 'Préférences',
				accept: 'Continuer'
			}
		...
		summary: {
			...
			who: {
				...
				description: "Nous et seulement quelques partenaires sélectionnées peuvent utiliser vos données. Vous pouvez personnaliser vos choix ci-dessus ou continuer à utiliser notre site si vous êtes d'accord.",
